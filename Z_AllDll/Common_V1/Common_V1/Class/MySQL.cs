...
namespace Common_V1
{
    ...
    {
        const string Constr = "database=te_test;Password=merry@TE;user ID=merryte;server=10.175.5.59";
        ...
        public static string GetData(string sql, out string[][] dataTable)
        {
            dataTable = new string[0][];

            try
            {
                if (!Open()) return "Connect to the database False";
